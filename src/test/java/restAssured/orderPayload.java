...
public class orderPayload extends mainSalesOrderClass {
    public static String createOrderPayload() {
        return "<Order DocumentType=\"0001\" EnterpriseCode=\"Matrix\" >\n" +
                "<OrderLines>\n" +
    ...
    public static String createShipment(String orderNo) {
        return "<Shipment ActualFreightCharge=\"35.12\" ActualShipmentDate=\"2024-04-23T04:08:32+00:00\" SellerOrganizationCode=\"Matrix\" CarrierServiceCode=\"2nd Day Air\" DocumentType=\"0001\" EnterpriseCode=\"Matrix\" SCAC=\"UPSN\" ShipNode=\"STORE_VENDOR02\" TotalWeight=\"5.00\">\n" +
                "    <Containers>\n" +
